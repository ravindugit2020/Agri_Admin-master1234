export class ProductsDTO{
  ...
  constructor(farmer_name: string, farmer_contact: string, product_title: string, product_desc: string, product_img: string, product_price: string, fertilizer: string, status: string) {
