export class ExpertDTOS{
  private _expert_id: string;
  ...
  constructor(expert_id: string, expert_name: string, expert_password: string, expert_title: string, expert_desc: string, expert_contact: string, expert_mail: string, expert_img: string, status: string) {
    this._expert_id = expert_id;
  ...
  get expert_id(): string {
    return this._expert_id;
  }

  set expert_id(value: string) {
    this._expert_id = value;
  }
